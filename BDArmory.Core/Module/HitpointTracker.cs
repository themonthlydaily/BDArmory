                    ...
                    if (maxHitPoints <= 0)
                    {
                        ...
                        if (isProcWing)
                        {
                            ...
                            else
                            {
                                ...
                                hitpoints = (float)Math.Round(part.Modules.GetModule<ModuleLiftingSurface>().deflectionLiftCoeff, 2) * 700 * hitpointMultiplier * 0.333f; //this yields ame reqult, but not beholden to mass changes
