...
namespace BDArmory.Core
{
    public class BDArmorySettings
    {
        ...
        [BDAPersistantSettingsField] public static float EXP_DMG_MOD_BATTLE_DAMAGE = 6.75f;     // Battle damage explosion damage multiplier (FIXME needs tuning; Note: CASE explosions used Missile mod and fuel explosions used Ballistic mod)
