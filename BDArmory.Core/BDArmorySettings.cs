...
namespace BDArmory.Core
{
    public class BDArmorySettings
    {
        ...
        [BDAPersistantSettingsField] public static float COMPETITION_KILLER_GM_MAX_ALTITUDE = 30;      // Altitude (high) in km at which to kill off craft.
        [BDAPersistantSettingsField] public static float COMPETITION_KILLER_GM_MIN_ALTITUDE = -1;      // Altitude (low) in km at which to kill off craft.
