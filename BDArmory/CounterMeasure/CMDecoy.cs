...
namespace BDArmory.CounterMeasure
{
    public class CMDecoy : MonoBehaviour
    {
        ...
        public void SetAcoustics(Vessel sourceVessel)
        {
            ...
            TargetInfo tInfo = sourceVessel.gameObject.GetComponent<TargetInfo>();
            if (tInfo == null)
            {
                tInfo = sourceVessel.gameObject.AddComponent<TargetInfo>();
            }
            acousticSig = BDATargetManager.GetVesselAcousticSignature(sourceVessel, tInfo, Vector3.zero);
            audio = acousticSig;
