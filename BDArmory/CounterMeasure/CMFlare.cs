    ...
    public class CMFlare : MonoBehaviour
    {
        ...
        public void SetThermal(Vessel sourceVessel)
        {
            ...
            */
            ...
            // Alternate thermal generator, adjusts heat range further for higher temps up to 5000k.
            /*
            thermal = BDATargetManager.GetVesselHeatSignature(sourceVessel);
            ...
            */
            ...
            float thermal = BDATargetManager.GetVesselHeatSignature(sourceVessel);
            ...
            thermal = thermal * UnityEngine.Random.Range(thermalMinMult, 1.75f - thermalMinMult + 0.65f);
