    ...
    class FireFX : MonoBehaviour
    {
        ...
        void Detonate()
        {
            ...
            if (!parentPart.partName.Contains("exploding"))
            {
                ...
                {
                    ExplosionFx.CreateExplosion(parentPart.transform.position, tntMassEquivalent, explModelPath, explSoundPath, ExplosionSourceType.BattleDamage, tntMassEquivalent, null, parentPart.vessel != null ? parentPart.vessel.vesselName : null, "Fuel");
