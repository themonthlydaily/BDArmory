...
namespace BDArmory.FX
{
    class FireFX : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            ...
            else transform.rotation = Quaternion.FromToRotation(Vector3.up, VectorUtils.GetUpDirection(transform.position));
        ...
        public void AttachAt(Part hitPart, Vector3 hit, Vector3 offset, string sourcevessel)
        {
            ...
            transform.rotation = Quaternion.FromToRotation(Vector3.up, VectorUtils.GetUpDirection(transform.position));
