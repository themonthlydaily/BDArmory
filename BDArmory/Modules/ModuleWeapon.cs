    ...
    public class ModuleWeapon : EngageableWeapon, IBDWeapon
    {
        ...
        public void RunTrajectorySimulation()
        {
            ...
            (BDArmorySettings.DRAW_DEBUG_LINES || (vessel && vessel.isActiveVessel && !aiControlled && !MapView.MapIsEnabled && !pointingAtSelf && eWeaponType != WeaponTypes.Rocket))))
            {
                ...
                else if (eWeaponType == WeaponTypes.Rocket || (eWeaponType == WeaponTypes.Ballistic && BDArmorySettings.AIM_ASSIST && BDArmorySettings.DRAW_AIMERS))
                {
                    ...
                    Vector3 simVelocity = part.rb.velocity + (baseBulletVelocity * fireTransform.forward); //  + Krakensbane.GetFrameVelocityV3f()
        ...
        void TrackIncomingprojectile()
        {
            ...
            if (weaponManager && aiControlled)
            {
                ...
                {
                    //Debug.Log("[APS DEBUG] bulletCount: " + BDATargetManager.FiredBullets.Count + "; rocketCount: " + BDATargetManager.FiredRockets.Count + "; missileCount: " + BDATargetManager.FiredMissiles.Count);
                ...
                if (tgtShell != null || tgtRocket != null || MissileTgt != null)
                {
                    targetVelocity = tgtVelocity - Krakensbane.GetFrameVelocityV3f();
