        ...
        */
        ...
        bool GetLaunchAuthorization(Vessel targetV, MissileFire mf)
        {
            ...
            if (missile != null && targetV != null)
            {
                ...
                float boresightFactor = (targetV.LandedOrSplashed || missile.allAspect) ? 0.75f : 0.35f; // Allow launch at close to maxOffBoresight for ground targets or missiles with allAspect = true
