        ...
        */
        ...
        void SearchForHeatTarget()
        {
            if (CurrentMissile != null)
            {
                ...
                heatTarget = BDATargetManager.GetHeatTarget(vessel, vessel, new Ray(CurrentMissile.MissileReferenceTransform.position + (50 * CurrentMissile.GetForwardTransform()), direction), heatTarget.signalStrength, scanRadius, CurrentMissile.heatThreshold, CurrentMissile.allAspect, this);
            }
        }
