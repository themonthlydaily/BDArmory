...
namespace BDArmory.Settings
{
    public class BDArmorySettings
    {
        ...
        [BDAPersistentSettingsField] public static float ASPECTED_RCS_OVERALL_RCS_FACTOR = 0.25f;   //When ASPECTED_RCS = true, final aspected RCS will be = [Aspected] * (1-ASPECTED_RCS_OVERALL_RCS_FACTOR) + [Overall] * ASPECTED_RCS_OVERALL_RCS_FACTOR
