...
namespace BDArmory.Settings
{
    public class BDArmorySettings
    {
        ...
        [BDAPersistentSettingsField] public static bool PWING_THICKNESS_AFFECT_MASS_HP = true;  //pWing thickness contributes to its mass alc instead of a static LiftArea derived value
