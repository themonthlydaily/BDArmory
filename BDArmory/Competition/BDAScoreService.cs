...
namespace BDArmory.Competition
{
    ...
    public class BDAScoreService : MonoBehaviour
    {
        ...
        private IEnumerator ExecuteHeat(string hash, HeatModel model)
        {
            ...
            spawner.SpawnAllVesselsOnce(BDArmorySettings.VESSEL_SPAWN_GEOCOORDS, BDArmorySettings.VESSEL_SPAWN_ALTITUDE, BDArmorySettings.VESSEL_SPAWN_DISTANCE_FACTOR, BDArmorySettings.VESSEL_SPAWN_DISTANCE_TOGGLE, BDArmorySettings.VESSEL_SPAWN_EASE_IN_SPEED, true, true, hash);
