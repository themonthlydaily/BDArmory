                        ...
                        for (int roundIndex = 0; roundIndex < numberOfRounds; ++roundIndex)
                        {
                            ...
                            while (selectedFiles.Count > 0)
                            {
                                rounds[roundIndex].Add(rounds[roundIndex].Count, new CircularSpawnConfig(
                                    ...
                                    (BDArmorySettings.RUNWAY_PROJECT_ROUND == 33 ? 10 : BDArmorySettings.RUNWAY_PROJECT_ROUND == 53 ? FlightGlobals.currentMainBody.atmosphere ? (FlightGlobals.currentMainBody.atmosphereDepth + (FlightGlobals.currentMainBody.atmosphereDepth / 10)) : 50000 : BDArmorySettings.VESSEL_SPAWN_ALTITUDE),
