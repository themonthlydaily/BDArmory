    ...
    public class BDArmorySetup : MonoBehaviour
    {
        ...
        void WindowSettings(int windowID)
        {
            ...
            if (BDArmorySettings.GENERAL_SETTINGS_TOGGLE)
            {
                ...
                BDArmorySettings.GRAVITY_HACKS = GUI.Toggle(SRightRect(++line), BDArmorySettings.GRAVITY_HACKS, Localizer.Format("Increase Gravity on Death"));//"Gravity hacks"
            ...
            if (BDArmorySettings.SLIDER_SETTINGS_TOGGLE)
            {
                ...
                terrainAlertFrequency = GUI.HorizontalSlider(SRightSliderRect(line), terrainAlertFrequency, 1f, 5f);
                ...
                cameraSwitchFrequency = GUI.HorizontalSlider(SRightSliderRect(line), cameraSwitchFrequency, 1f, 10f);
