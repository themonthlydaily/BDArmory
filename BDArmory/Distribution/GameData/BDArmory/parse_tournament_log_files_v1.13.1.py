...
parser.add_argument('-w', '--weights', type=str, default="0.1,0,0,-1,1,2e-3,2,1,5e-3,2e-3,1e-5,1e-5,0.1,0.05,2e-3,1e-3,2e-5,2e-5,0.1,0.05,0.01,0.005,1e-7,1e-7,0.01,0.005,0,0", help="Score weights (in order of main columns from 'Wins' to 'Ram').")
